...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 echo $id_produk; echo " usere "; echo $id_user; 
	 echo $email;
	 ?> -->
	 <a href="<?php echo base_url()."C_keranjang/hapus_keranjang/".$email;?>">
	 ...
	 <?php 
	 	$total = 0;
	 	foreach ($data_produk as $datatabel) 
	 { ?>
		...
		<?php echo $datatabel['type_produk']; ?>
		 - <b>Rp <?php echo $datatabel['harga_produk']; ?></b>
			...
			<a href="<?php echo base_url()."C_keranjang/hapus_item_keranjang/".$datatabel['id_keranjang']."/".$email;?>">
				<h3>
			...
			<hr> 
			<?php 
				$total=$total+$datatabel['harga_produk'];
				//echo "Rp ".$total;
			?>
			<form method="POST" action="<?php echo base_url()."C_keranjang/check_out/".$email."/".$total; ?>">
				<input type="hidden" name="id_produk[]" value="<?php echo $datatabel['id_produk']; ?> ">
				<input type="hidden" name="id_user" value="<?php echo $datatabel['id_user']; ?> ">
				 <br> 
				<?php } ?>
				<h5>
					Total Belanja : 
				...
				<button type="submit" class="btn btn-large btn-primary pull-right" value="Check Out">Check Out</button>
				<br><br>
			</form>
