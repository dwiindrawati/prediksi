...
<!-- Sidebar end=============================================== -->
	...
	<?php $email=$this->session->userdata('namas'); ?>
		...
		<?php echo $jalan;?> ,Kelurahan <?php echo $kelurahan;?> ,Kecamatan <?php echo $kecamatan;?>, <?php echo $kota;?>, <?php echo $provinsi;?> , Kode POS <?php echo $kode_pos;?>
		<hr>
		...
		BRI XXXXXXXXXXXXXXX (AN : ERI ELI LAVINDI)
		<hr>

		<form class="form-horizontal" method ="post" action="<?php echo base_url()."C_pembayaran/upload_bukti_pembayaran/$email/$total"; ?>" role="form" enctype="multipart/form-data">

			<h4>Upload Bukti Pembayar</h4>
