...
<!-- Sidebar end=============================================== -->
	...
	<form class="form-horizontal" method ="post" action="<?php echo base_url()."C_user/input_alamat/$email"; ?>" >
	
		<h4>Infomasi Alamat Anda</h4>
		
		<div class="control-group">
			<label class="control-label" for="inputFname1">Jalan<sup></sup></label>
			<div class="controls">
			  <input type="text" name="jalan" value="<?php echo $jalan;?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Kelurahan<sup></sup></label>
			<div class="controls">
			  <input type="text" name="kelurahan" value="<?php echo $kelurahan;?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Kecamatan<sup></sup></label>
			<div class="controls">
			  <input type="text" name="kecamatan" value="<?php echo $kecamatan;?>">
			</div>
		</div>
		 <div class="control-group">
			<label class="control-label" for="inputFname1">Kota<sup></sup></label>
			<div class="controls">
			  <input type="text" name="kota" value="<?php echo $kota;?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Provinsi<sup></sup></label>
			<div class="controls">
			  <input type="text" name="provinsi" value="<?php echo $provinsi;?>">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" for="inputFname1">Kode Pos<sup></sup></label>
			<div class="controls">
			  <input type="text" name="kode_pos" value="<?php echo $kode_pos;?>">
			</div>
		</div>
	<div class="control-group">
			<div class="controls">
				<input class="btn btn-large btn-success" type="submit" value="Simpan" />
			</div>
		</div>		
	</form>
</div>
