...
<!-- Sidebar end=============================================== -->
	...
	<h3> Barang Dalam Proses Pengiriman</h3>	
	<div class="well">
	<!--
	...
	<div class="alert fade in">
	 ...
	 <a href="<?php echo base_url()."C_pembelian/produk_diterima/".$email;?>">
	 <h3><small class="pull-right"><font color="green"> <i class="icon-fixed-width icon-check"></i>Barang Di Terima</font></small></h3>
	 </a>
	 <br>
	 <hr>
	<br>
	...
	<?php 
	 	$total = 0;
	 	foreach ($data_kirim as $datatabel) 
	 { ?>
		...
		<!-- <a href="<?php echo base_url()."C_transaksi/item_produk_diterima/".$email."/".$datatabel['id_beli'];?>">
			<h3>
				<small class="pull-right">
					<font color="green"> 
						<i class="icon-fixed-width icon-check"></i>Di Terima 
					</font>
				</small>
			</h3>
			</a> -->
