...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <?php $usernamme=$this->session->userdata('username'); ?>
	<form class="form-horizontal" method ="post" action="<?php echo base_url()."C_user/update_profil/".$username; ?>" >
		
		<h4>Infomasi Personal Anda</h4>
		
		<div class="control-group">
			<label class="control-label" for="inputFname1">Nama<sup></sup></label>
			<div class="controls">
			  <input type="text" name="nama_user" value="<?php echo $nama;?>" >
			</div>
		 </div>
		 <div class="control-group">
	...
	<div class="control-group">
		...
		<div class="controls">
		  <input type="password" name="password_user" value="password" >
		</div>
	  </div>	  
		<div class="control-group">
			<br>
			<label class="control-label" for="inputLnam"><sup>*</sup> Tidak Dapat Di Rubah</label>
		</div>
	  </div>	
	<div class="control-group">
			<div class="controls">
