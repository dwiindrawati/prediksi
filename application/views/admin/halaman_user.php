                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $datatabel['email_user']; ?></td>
                                                    <td><?php echo $datatabel['gender_user']; ?></td>
                                                    <td><?php echo $datatabel['no_hp_user']; ?></td>
                                                    <td><?php echo $datatabel['tanggal_pembuatan']; ?></td>
                                                    <td>
                                                    <a href="<?php echo base_url()."C_user/halaman_alamat_user/".$datatabel['id_user'];?>">Alamat </a>
                                                    </td>
                                                </tr>
                                        </tbody>
                                        <?php  } ?>
